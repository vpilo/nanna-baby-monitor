...
interface ErrorReportingRepository {
    ...
    /**
     * Build the pending report, and hand it over to the user's mail client.
     */
    suspend fun send(): Result<ReportHandoff>

    /**
     * Delete the pending report, the previous session's files, and any report file handed over to the mail client.
     */
    suspend fun discard()
}
