...
class PairedDevicesScreenViewModel(
    private val getPairedDevicesForCurrentRoleFlowUseCase: GetPairedDevicesForCurrentRoleFlowUseCase,
    ...
    override fun SubscriptionScope.onSubscribed() {
        getPairedDevicesForCurrentRoleFlowUseCase.invoke().subscribe { clients -> state.copy(devices = clients).update() }
    }
