...
android {
    ...
    signingConfigs {
        val keystoreFile = layout.projectDirectory.file("release/babymonitor.jks").asFile
        val keystorePassword = providers.environmentVariable("BABY_MONITOR_KEYSTORE_PASSWORD").orNull
